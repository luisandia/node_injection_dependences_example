...
function asClass(Type, opts) {
    ...
    const resolve$$1 = generateResolve(newClass, Type);
...
export { ExtendableError, AwilixError, AwilixTypeError, AwilixResolutionError, listModules, createContainer, RESOLVER, asValue, asFunction, asClass, aliasTo, createBuildResolver, createDisposableResolver, InjectionMode, Lifetime };
